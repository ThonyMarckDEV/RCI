    ...
    <div>
      ...
      >
        <div className="flex flex-col justify-between h-full">
          <div>
            <h2 className="text-3xl font-bold mb-8 text-center text-yellow-500">RCI Admin Panel</h2>
            <ul>
              {/* Categorías */}
              <li className="mb-4">
                <div
                ...
                {openProductos && (
                  <ul className="ml-8 mt-2 space-y-2">
                    <li>
                      <a href="/admin/productos/agregar" className="text-black hover:text-gray-600 transition-all duration-300">
                        Agregar Productos
                      </a>
                    </li>
                    <li>
                      <a href="/admin/productos/editar" className="text-black hover:text-gray-600 transition-all duration-300">
                        Editar Productos
                      </a>
                    </li>
                  </ul>

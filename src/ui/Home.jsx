      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full">
          <h1
            ...
            style={{ textShadow: '6px 6px 12px rgba(0, 0, 0, 0.9)', animationDelay: '0.5s' }}
          >
            Muebles RCI
          </h1>
          <p
            ...
            style={{ textShadow: '5px 5px 10px rgba(0, 0, 0, 0.8)', animationDelay: '1s' }}
          >
